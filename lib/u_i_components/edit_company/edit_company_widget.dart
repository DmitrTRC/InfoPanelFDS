...
class _EditCompanyWidgetState extends State<EditCompanyWidget>
  ...
  void initState() {
    ...
    _model.projectNameTextController ??=
        TextEditingController(text: widget.companyRef?.name);
    _model.projectNameFocusNode ??= FocusNode();

    _model.descriptionTextController ??=
        TextEditingController(text: widget.companyRef?.description);
    _model.descriptionFocusNode ??= FocusNode();

    _model.projectURLTextController ??=
        TextEditingController(text: widget.companyRef?.website);
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 8.0),
                                            child: Text(
                                              'Please enter the information below to create a company.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        await widget.companyRef!.reference

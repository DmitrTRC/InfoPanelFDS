...
import 'user_other_base_model.dart';
export 'user_other_base_model.dart';

class UserOtherBaseWidget extends StatefulWidget {
  const UserOtherBaseWidget({
    super.key,
    this.userRef,
  });
  ...
  @override
  State<UserOtherBaseWidget> createState() => _UserOtherBaseWidgetState();
}

class _UserOtherBaseWidgetState extends State<UserOtherBaseWidget> {
  late UserOtherBaseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserOtherBaseModel());

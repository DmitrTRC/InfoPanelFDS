...
import 'ticket_edit_modal_model.dart';
export 'ticket_edit_modal_model.dart';

class TicketEditModalWidget extends StatefulWidget {
  const TicketEditModalWidget({
    super.key,
    required this.taskRef,
  });

  final ActivityRecord? taskRef;

  @override
  State<TicketEditModalWidget> createState() => _TicketEditModalWidgetState();
}

class _TicketEditModalWidgetState extends State<TicketEditModalWidget>
    with TickerProviderStateMixin {
  late TicketEditModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TicketEditModalModel());
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    controller: _model
                                            .dropDownDesktopValueController ??=
                                        FormFieldController<String>(
                                      _model.dropDownDesktopValue ??=
                                    ...
                                    onChanged: (val) => setState(() =>
                                        _model.dropDownDesktopValue = val),
                                    width: 302.0,
                                    height: 50.0,
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await widget.taskRef!.reference
                                        ...
                                        dueDate: _model.datePicked != null
                                            ? _model.datePicked

...
class TaskDetailsWidget extends StatefulWidget {
  ...
  final ActivityRecord? taskDetails;
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            if (widget.taskDetails?.status == 'In Progress')
                              FFButtonWidget(
                                onPressed: () async {
                                  // complete_CurrentActivity
                                  ...
                                  await ActivityRecord.collection
                                      ...
                                      .set(createActivityRecordData(
                                        ...
                                        description:
                                            '${currentUserDisplayName} has marked  ${valueOrDefault<String>(
                                          widget.taskDetails?.name,
                                          '[Task Name]',
                                        )} as completed.',
                                        type: 'Update',
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'You have marked ${valueOrDefault<String>(
                                          widget.taskDetails?.name,
                                          '[Task name]',
                                        )} as completed!',
                                        style: TextStyle(
                            ...
                            if (widget.taskDetails?.status == 'Pending')
                              FFButtonWidget(
                                onPressed: () async {
                                  // complete_CurrentActivity
                                  ...
                                  await ActivityRecord.collection
                                      ...
                                      .set(createActivityRecordData(
                                        ...
                                        type: 'Update',
                                        actionType: 'Marked as in Progress',
                                      ));
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Text(
                              valueOrDefault<String>(
                                dateTimeFormat(
                                    'MMMEd', widget.taskDetails?.dueDate),
                                'No Due Date',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Text(
                              dateTimeFormat(
                                  'MMMEd', widget.taskDetails!.dateCreated!),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  valueOrDefault<String>(
                                    dateTimeFormat(
                                        'jm', widget.taskDetails?.dateCreated),
                                    '-',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                    ...
                    Row(
                      ...
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<UsersRecord>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final createdByUsersRecord = snapshot.data!;
                                return Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    Container(
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            valueOrDefault<String>(
                                              createdByUsersRecord.displayName,
                                              'Steph Curry',
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                        ...
                        if (widget.taskDetails!.usersNotified.length >= 1)
                          Expanded(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 12.0),
                              child: FutureBuilder<UsersRecord>(
                                future: UsersRecord.getDocumentOnce(
                                    widget.taskDetails!.usersNotified.first),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                  ...
                                  final assignedToUsersRecord = snapshot.data!;
                                  return Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.network(
                                              assignedToUsersRecord.photoUrl,
                                              width: 120.0,
                                              height: 120.0,
                                              fit: BoxFit.cover,
                                            ),
                ...
                child: StreamBuilder<List<ActivityRecord>>(
                  stream: queryActivityRecord(
                    queryBuilder: (activityRecord) => activityRecord
                        .where(
                          'activityRef',
                          isEqualTo: widget.taskDetails?.reference,
                        )
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (listViewActivityRecordList.isEmpty) {
                      return EmptyListGenericWidget(
                        ...
                        title: 'No Comments',
                        subTitle: 'No comments have been left for this task.',
                      );
                    }
                            ...
                            onPressed: () async {
                              ...
                              await ActivityRecord.collection.doc().set({
                                ...createActivityRecordData(
                                  ...
                                  activityRef: widget.taskDetails?.reference,
                                ),
                                ...mapToFirestore(
                                  {
                                    'usersNotified':
                                        widget.taskDetails?.usersNotified,
                                  },
                                ),
                              });

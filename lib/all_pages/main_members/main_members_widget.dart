...
class MainMembersWidget extends StatefulWidget {
  const MainMembersWidget({super.key});

  @override
  State<MainMembersWidget> createState() => _MainMembersWidgetState();
}
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                            ...
                                            if (listViewUsersRecordList
                                              ...
                                              return Container(
                                                ...
                                                child: EmptyListGenericWidget(
                                                  ...
                                                  title: 'No Teammates',
                                                  subTitle:
                                                      'You don\'t have any users associated with your company.',
                                                ),
                                              );
                                            }
                                                                    ...
                                                                    if (responsiveVisibility(
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child: FutureBuilder<
                                                                            CompaniesRecord>(
                                                                          future:
                                                                              CompaniesRecord.getDocumentOnce(listViewUsersRecord.companyRef!),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            // Customize what your widget looks like when it's loading.
                                                                            if (!snapshot.hasData) {
                                    ...
                                    if ((currentUserDocument?.companyRef ==
                                            null) &&
                                        (_model.searchActive == false))
                                      Align(
                                        alignment:
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: wrapWithModel(
                                                      model: _model
                                                          .emptyListGenericModel,
                                                      updateCallback: () =>
                                                          setState(() {}),
                                                      child:
                                                          EmptyListGenericWidget(
                                                        icon: Icon(
                                                          Icons
                                                              .business_rounded,
                                                          color: FlutterFlowTheme
                                            ...
                                            return Center(
                                              child: Container(
                                                ...
                                                child: EmptyListGenericWidget(
                                                  ...
                                                  title: 'No Matches',
                                                  subTitle:
                                                      'It seems you don\'t have any users that match your search results.',
                                                ),
                                              ),
                                            );
                                          }
